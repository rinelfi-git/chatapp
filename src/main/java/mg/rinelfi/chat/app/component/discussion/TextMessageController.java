...
public abstract class TextMessageController {
    ...
    protected void addReaction(HBox reactionContainer, String image) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/mg/rinelfi/chat/app/component/discussion/MessageReactionView.fxml"));
    ...
    protected void removeReaction(HBox reactionContainer, int reaction) {
        String image = "/mg/rinelfi/chat/img/reaction/" + this.reactionImages[Math.abs(reaction) - 1];

...
import mg.rinelfi.chat.observer.ReactionRequestConsumer;
import mg.rinelfi.chat.observer.ReactionRequestListener;
...
public class TextMessageMeController extends TextMessageController implements Initializable, ReactionRequestListener {
    ...
    private static final String[] messageStatusImages = new String[]{
        "/mg/rinelfi/chat/img/message/status/sent.png",
        "/mg/rinelfi/chat/img/message/status/received.png",
        "/mg/rinelfi/chat/img/message/status/seen.png"
    };
    ...
    public void doReactOn() {
        ...
        ((ReactionActionListener) reactionController).onReact(reaction -> {
            ...
            if (this.myReaction >= 0) {
                String image = "/mg/rinelfi/chat/img/reaction/" + this.reactionImages[reaction];
